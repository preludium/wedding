...
export default {
  ...
  welcome: {
    ...
    bullet2: '<strong>Les indications</strong> - pour vous aider à rejoindre facilement le lieu.',
    bullet3: '<strong>Le programme de la journée</strong> - pour savoir à quoi vous attendre.',
  ...
  questionnaire: {
    ...
    busToNovotel: {
      title: 'Je souhaite réserver une place dans le bus de nuit du château à l’hôtel',
      yes: 'Oui',
      no: 'Non',
    },
