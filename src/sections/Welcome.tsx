      ...
      <section className="flex flex-col bg-[#fcfcfc] py-28 gap-12">
        ...
        <div className="container grid grid-cols-2 items-center -md:grid-cols-1 -md:gap-8 md:gap-20">
          ...
          <div className="relative grid grid-cols-12">
            <img
              src={churchUrl}
              className="aspect-square w-[350px] row-start-1 col-start-1 col-span-8 rounded-lg shadow-around-sm"
            />
            <img
              src={castleUrl}
              className="aspect-[3/2] w-[400px] mt-[70%] row-start-1 col-start-6 col-span-7 rounded-lg shadow-around-sm"
            />
          </div>
        </div>
      </section>
