...
export const Questionnaire = () => {
  ...
  const FormSchema = z.discriminatedUnion('confirmAttendance', [
    z.object({
      ...
      email: z.string({ required_error: t('questionnaire.requiredField') }).email(),
      ...
      anyOtherQueries: z.string({ required_error: t('questionnaire.requiredField') }).optional(),
    }),
    z.object({
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  <div className="flex flex-col gap-2">
                    <h3 className="text-lg font-medium">{t('questionnaire.section.menu')}</h3>
                    <RadioGroupField
                      name="seafood"
                  ...
                  />
                  <div className="flex flex-col gap-2">
                    <h3 className="text-lg font-medium">{t('questionnaire.section.hotel')}</h3>
                    <RadioGroupField
                      name="hotel"
                  ...
                  <div className="flex flex-col gap-2">
                    <h3 className="text-lg font-medium">{t('questionnaire.section.breakfast')}</h3>
                    <RadioGroupField
                      name="breakfast"
