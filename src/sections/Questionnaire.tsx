...
export const Questionnaire = () => {
  ...
  return (
    <section
      id="questionnaire"
      className="flex flex-col gap-16 justify-center items-center text-center py-28 bg-[#f3f3f3]">
      <div className="container flex flex-col gap-16 max-w-[1032px]">
        ...
        <Form {...form}>
          <form
            className="flex flex-col gap-8 md:min-w-[900px] p-10 rounded-xl shadow-around text-start bg-secondary"
              ...
              <div className="flex flex-col gap-6">
                ...
                <div
                  ...
                  <RadioGroupField
                    ...
                    required={!FormSchema.shape.meat.isOptional()}
                    disabled={sent}
                  />
                  <div className="flex flex-col gap-2">
                    <h3 className="text-lg font-medium">
