...
export const AGENDA: AgendaItem[] = [
  ...
  },
  {
    ...
    desc: 'Tradycyjne powitanie Pary Młodej przez Rodziców.',
  },
...
export const INFO_CARDS: InfoCard[] = [
  ...
  // },
  {
    icon: 'ic-gift',
    title: 'Prezenty',
    desc: 'Największym prezentem jest dla nas Wasza obecność. Zamiast kwiatów i tradycyjnych upominków prosimy o kopertę. Wsparcie finansowe będzie dla nas najcenniejszym prezentem, który pomoże nam spełnić wspólne plany.',
  },
]
...
const VENUE_1_ADDRESS = import.meta.env.VITE_VENUE_1_ADDRESS || 'Adres zostanie podany wkrótce'
const VENUE_1_DESC =
...
const VENUE_2_ADDRESS = import.meta.env.VITE_VENUE_2_ADDRESS || 'Adres zostanie podany wkrótce'
const VENUE_2_DESC =
...
export const GALLERY_IDS: string[] = ['gal1', 'gal2', 'gal3', 'gal4', 'gal5', 'gal6']
